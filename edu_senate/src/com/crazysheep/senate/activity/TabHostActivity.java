...
public class TabHostActivity extends TabActivity implements
	...
	private void initRadios() {
		...
		((RadioButton) findViewById(R.id.radio_notify))
				.setOnCheckedChangeListener(this);
		((RadioButton) findViewById(R.id.radio_named))
		.setOnCheckedChangeListener(this);
...
//		.addTab(buildTabSpec("named", "named", NamedActivity.class));
	...
	private TabHost.TabSpec buildTabSpec(String tag, String indicator, @SuppressWarnings("rawtypes") Class cls) {
	...
	public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
		if (isChecked) {
			...
			case R.id.radio_notify:
				...
				break;
			case R.id.radio_named:
				this.mHost.setCurrentTabByTag("named");
				break;
